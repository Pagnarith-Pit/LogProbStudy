...
**Now, respond as a student**."""
    ...
    parser = argparse.ArgumentParser(description="Compute log-probability scores (single GPU).")
    parser.add_argument(
        "-m",
        "--model",
        dest="model_name",
    ...
    # Data paths
    data_path = Path("/home/ppit/punim2402/IndirectScore/asset/data/ReadyForLogProb.json")
    output_dir = Path("/home/ppit/punim2402/IndirectScore/asset/data/logprob_results") / model_tag
    ...
    print(f"Processed {processed} items, saved {len(results)} conversation results to {output_path}")